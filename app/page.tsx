...
export default function Home() {
  return (
    <div className="space-y-24">
      <section className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
        <div className="space-y-6">
          ...
          <p className="text-lg text-slate-700">
            Built with Next.js App Router, Tailwind CSS, and Prisma for Postgres
            so you can go from idea to launch without stitching together the
            basics.
          </p>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-brand-900/5">
          ...
          <div className="relative space-y-4">
            ...
            <div className="rounded-xl border border-dashed border-brand-200 bg-brand-50/60 p-4 text-sm text-brand-900">
              Typed database access, Tailwind styling, and linting/formatting
              are configured so you can focus on features.
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="space-y-10">
        <div className="space-y-3">
          ...
          <h2 className="text-3xl font-bold text-slate-900">
            A foundation for commerce teams
          </h2>
          <p className="max-w-2xl text-slate-700">
            Compose a storefront, hook it up to your supplier feeds, and
            customize the retro brand identity. Deploy to Vercel or your
            favorite platform with environment validation baked in.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            ...
            <h3 className="text-2xl font-bold text-slate-900">
              Built for retro tech accessories
            </h3>
            <p className="text-slate-700">
              Swap in your own categories and supplier SKUs with Prisma models.
            </p>
          </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {[1, 2, 3].map((item) => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-600">
                Showcase your top-performing SKUs with stock status and supplier
                mappings powered by Prisma.
              </p>
            </div>
          ))}
        </div>
      ...
      <section
        id="contact"
        className="space-y-4 rounded-3xl border border-brand-200 bg-brand-50/60 p-10 shadow-sm"
      >
        <h3 className="text-2xl font-bold text-slate-900">
